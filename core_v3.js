...
(function(){
    ...
    for (const mv of mkVaryCandidates){
      for (const [aIdx,bIdx] of ckPairs){
        for (const mode of modes){
          const attempt = tryBuild({tmk, ds, macs, step, parityOn, randomizeOn, shuffleListOn, rng, mv, aIdx, bIdx, mkCount, ckPerMk, doorCount, Avals:stepAlign(mode.A), Bvals:stepAlign(mode.B)});
  ...
  function tryBuild({tmk, ds, macs, step, parityOn, randomizeOn, shuffleListOn, rng, mv, aIdx, bIdx, mkCount, ckPerMk, doorCount, Avals, Bvals}){
